    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i <= 1; i++) {
                ...
                buff = "TPEIn064 010        MPC1MPC1SYS213524678"; //包头内容，xxxx交易，010网点，MPC1终端，MPC2柜员，包头定长51个字符
...
//n064 建行 查账户明细 [日期  账号  行号 币别 起始序号]
                list.add("20141010");               //起始日期
                list.add("20141023");               //结束日期
                list.add("37101985510050404002");   //收款人帐号
                list.add("105");//行号
                list.add("");//币别
                list.add("0");//起始序号
...
/*
                ...
                list.add("1");                     //费用帐户类型
                list.add("                      ");//费用帐户
                list.add("11000071209595027012");  //收款人帐号
                list.add("泌阳县新盛电器维修有限公司");//收款人名称
                list.add("泌阳县农村信用合作社联合社                                                      ");//收款行行名
                list.add("402511301018                                                                    ");//保留项
                list.add("                                        ");                                        //保留项
                list.add("1                                                                               ");//汇款人名称150
                list.add("GE冰箱展台制作                                                                  ");//汇款用途150
                list.add(" ");    //保留项
                list.add("402511301018");          //收款行机构号、行号
                list.add("保留项    ");            //保留项
                list.add(" ");                     //保留项
                list.add("FSPP293062000001");      //FS流水号
                list.add("1300000000000066");      //交易流水号
*/
...
/*
//n022       对公代理支付结果查询
             list.add("MPC1000147231421  ");                       //  MPCNO         18位
             list.add("1100000269791273");                         //  交易流水号    16位
             list.add("20141009");                                 //  交易日期      8位
