    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i <= 1; i++) {
                ...
                buff = "TPEIn063 010        MPC1MPC1SYS213524678"; //包头内容，xxxx交易，010网点，MPC1终端，MPC2柜员，包头定长51个字符
...
//n063 建行 查账户明细 [日期  账号  行号 币别 起始序号]
                list.add("20141028");               //业务日期
