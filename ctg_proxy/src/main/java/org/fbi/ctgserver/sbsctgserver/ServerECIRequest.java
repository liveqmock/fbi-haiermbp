...
// Source File Name:   ServerECIRequest.java
...
// Referenced classes of package com.ibm.ctg.server:
//			ServerGatewayRequest, ServerMessages, MsgQualMgr, TraceMessages

public class ServerECIRequest extends ECIRequest
	implements ServerGatewayRequest, Cloneable
{

	public static final String CLASS_VERSION = "@(#) java/com/ibm/ctg/server/ServerECIRequest.java, client_java, c602, c602-20060418 1.50.2.2 05/05/09 15:04:34";
	private static final String COPYRIGHT_NOTICE = "(c) Copyright IBM Corporation 2000, 2005.";
		...
		throws IOException
	{
		...
		{
			T.ex(this, throwable);
			String s1 = ServerMessages.getMessage("6556", new Object[] {
				throwable
			});
	...
	protected int validateCommareaOutboundLength(ECIRequest ecirequest)
	{
		...
		default:
			...
			if (i > ecirequest.Commarea.length)
		...
		throws IOException
	{
			...
			case 9: // '\t'
				...
				if (iNumOfSystems <= 0 || Commarea == null || Commarea_Length <= 0)
					...
					catch (ArrayIndexOutOfBoundsException arrayindexoutofboundsexception)
					{
						...
						String s = ServerMessages.getMessage("6555", new Object[] {
		...
		{
			T.ex(this, throwable);
			String s1 = ServerMessages.getMessage("6555", new Object[] {
				throwable
			});
			throw new IOException(s1);
		}
		...
		throws IOException
	{
		...
		{
			T.ex(this, throwable);
			String s = ServerMessages.getMessage("6553", new Object[] {
				throwable
			});
			throw new IOException(s);
		}
		...
		throws Throwable
	{
		...
		catch (Throwable throwable)
		{
			...
			throw new Throwable(ServerMessages.getMessage("6554", new Object[] {
				s
			}));
		}
		Cics_Rc = ai[4];
		...
		if (Cics_Rc == 0)
			...
			if (getVersion() < 0x401000 && flag1 && i < Commarea_Length)
			{
	...
	public void terminate()
	{
		...
		catch (Throwable throwable)
		{
			T.ex(this, throwable);
			if (T.bTrace)
				T.traceln(TraceMessages.getMessage(62, throwable));
		}
		if (T.bDebug)
